<x-layouts.admin :title="__('view.admin.catalog.components.index.title')">
    <x-admin.index-shell :heading="__('view.admin.catalog.components.index.heading', ['count' => $count])">
        <nav class="navbar navbar-light bg-light">
            <div class="container-fluid">
                <a href="{{ route('admin.catalog.item-components.create') }}" type="button" class="btn btn-success"><i
                ...
                @endphp
                <x-admin.search-form
                    :action="route('admin.catalog.item-components.index')"
        ...
        <div class="row">
            <div class="col">
                <table class="table table-hover table-bordered">
                    <thead>
                        <form action="{{ route('admin.catalog.item-components.index') }}" method="GET">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center">
                                        <a href="{{ route('admin.catalog.item-components.show', $itemComponent->id) }}" type="button"
