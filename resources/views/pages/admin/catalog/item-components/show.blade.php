<x-layouts.admin :title="__('view.admin.catalog.components.show.title') . ' ' . $itemComponent->id">
            ...
            <div class="col-md-6">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            <a href="{{ route('admin.catalog.items.show', $itemComponent->item->id) }}" type="button"
                                class="btn btn-primary me-1"><i class="bi bi-eye-fill"></i> {{ __('view.admin.catalog.components.show.view') }}</a>
                            <a href="{{ route('admin.catalog.items.edit', $itemComponent->item->id) }}" type="button"
            ...
            <div class="col-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            <a href="{{ route('admin.catalog.items.show', $itemComponent->component->id) }}" type="button"
                                class="btn btn-primary me-1"><i class="bi bi-eye-fill"></i> {{ __('view.admin.catalog.components.show.view') }}</a>
                            <a href="{{ route('admin.catalog.items.edit', $itemComponent->component->id) }}" type="button"
                                class="btn btn-warning me-1"><i class="bi bi-pencil-fill"></i> {{ __('view.admin.catalog.components.show.edit') }}</a>
