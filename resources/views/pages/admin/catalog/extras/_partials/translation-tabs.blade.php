{{-- Expects: $contentLanguages, $preferredContentTabLanguageId, $extra (nullable), $aiTranslationUiEnabled (bool), $aiTranslationResource (optional), $aiTranslationFieldKeys (optional CSV) --}}
