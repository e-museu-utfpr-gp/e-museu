<x-layouts.admin :title="__('view.admin.catalog.extras.show.title') . ' ' . $extra->id">
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body d-flex">
                        <a href="{{ route('admin.catalog.extras.edit', $extra->id) }}" type="button" class="btn btn-warning me-1"><i
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            <a href="{{ route('admin.catalog.items.show', $extra->item->id) }}" type="button"
                                class="btn btn-primary me-1">
                                <i class="bi bi-eye-fill"></i>
                                {{ __('view.admin.catalog.items.show.view') }}
                            </a>
                            <a href="{{ route('admin.catalog.items.edit', $extra->item->id) }}" type="button"
