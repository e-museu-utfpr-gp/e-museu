{{-- Expects: $contentLanguages, $preferredContentTabLanguageId, $itemCategory (nullable), $aiTranslationUiEnabled (bool), $aiTranslationResource (optional), $aiTranslationFieldKeys (optional CSV) --}}
