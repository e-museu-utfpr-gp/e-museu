<x-layouts.admin :title="__('view.admin.catalog.item_tags.show.title') . ' ' . $itemTag->tag->id . '-' . $itemTag->item->id">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <a href="{{ route('admin.taxonomy.tags.show', $itemTag->tag->id) }}" type="button"
                                        class="btn btn-primary me-1"><i class="bi bi-eye-fill"></i> {{ __('view.admin.catalog.item_tags.show.view') }}</a>
                                    <a href="{{ route('admin.taxonomy.tags.edit', $itemTag->tag->id) }}" type="button"
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            <a href="{{ route('admin.catalog.items.show', $itemTag->item->id) }}" type="button"
                                class="btn btn-primary me-1"><i class="bi bi-eye-fill"></i> {{ __('view.admin.catalog.item_tags.show.view') }}</a>
                            <a href="{{ route('admin.catalog.items.edit', $itemTag->item->id) }}" type="button"
                                class="btn btn-warning me-1"><i class="bi bi-pencil-fill"></i> {{ __('view.admin.catalog.item_tags.show.edit') }}</a>
