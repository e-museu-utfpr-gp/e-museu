<x-layouts.admin :title="__('view.admin.catalog.items.show.title') . ' ' . $item->id">
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body d-flex">
                        <a href="{{ route('admin.catalog.items.edit', $item->id) }}" type="button" class="btn btn-warning me-1"><i
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <a href="{{ route('admin.catalog.item-categories.show', $item->itemCategory?->id) }}" type="button"
                                        class="btn btn-primary me-1"><i class="bi bi-eye-fill"></i> {{ __('view.admin.catalog.items.show.view') }}</a>
                                    <a href="{{ route('admin.catalog.item-categories.edit', $item->itemCategory?->id) }}" type="button"
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <h5 class="card-header d-flex justify-content-between">{{ __('view.admin.catalog.items.show.extra_info') }} <a type="button"
                                    ...
                                    href="{{ route('admin.catalog.extras.create', ['id' => $item->id, 'item_category' => $item->itemCategory?->id]) }}"><i
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <h5 class="card-header d-flex justify-content-between">{{ __('view.admin.catalog.items.show.related_tags') }}<a type="button"
                                    class="btn btn-success"
                                    href="{{ route('admin.catalog.item-tags.create', ['id' => $item->id, 'item_category' => $item->itemCategory?->id]) }}"><i
                                ...
                                <ul class="list-group list-group-flush">
                                    @foreach ($item->itemTags as $tagItem)
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex">
                                                <a href="{{ route('admin.catalog.item-tags.show', $tagItem->id) }}"
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <h5 class="card-header d-flex justify-content-between">{{ __('view.admin.catalog.items.show.related_components') }}<a
                                    ...
                                    href="{{ route('admin.catalog.item-components.create', ['id' => $item->id, 'item_category' => $item->itemCategory?->id]) }}"><i
                                ...
                                <ul class="list-group list-group-flush">
                                    @foreach ($item->itemComponents as $itemComponent)
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex">
                                                <a href="{{ route('admin.catalog.item-components.show', $itemComponent->id) }}"
                                                    type="button" class="btn btn-primary me-1"><i
                                                        class="bi bi-eye-fill"></i> {{ __('view.admin.catalog.items.show.view') }}</a>
