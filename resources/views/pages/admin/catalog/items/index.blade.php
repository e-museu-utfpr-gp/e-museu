<x-layouts.admin :title="__('view.admin.catalog.items.index.title')">
    <x-admin.index-shell :heading="__('view.admin.catalog.items.index.heading', ['count' => $count])">
        <nav class="navbar navbar-light bg-light">
            <div class="container-fluid">
                <a href="{{ route('admin.catalog.items.create') }}" type="button" class="btn btn-success"><i
        ...
        <div class="row">
            <div class="col">
                <table class="table table-hover table-bordered">
                    <thead>
                        <form action="{{ route('admin.catalog.items.index') }}" method="GET">
                            <tr>
