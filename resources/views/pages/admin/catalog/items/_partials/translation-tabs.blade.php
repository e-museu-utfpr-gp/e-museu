{{-- Expects: $contentLanguages, $preferredContentTabLanguageId, $item (nullable), $aiTranslationUiEnabled (bool), $aiTranslationResource (optional), $aiTranslationFieldKeys (optional CSV), $aiTranslationFieldLimits (optional array field => max int) --}}
