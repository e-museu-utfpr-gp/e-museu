{{-- Expects: $contentLanguages, $preferredContentTabLanguageId, $tag (nullable), $aiTranslationUiEnabled (bool), $aiTranslationResource (optional), $aiTranslationFieldKeys (optional CSV) --}}
