{{-- Expects: $contentLanguages, $preferredContentTabLanguageId, $tag (nullable), $aiTranslationUiEnabled (bool), $aiTranslationResource (optional), $aiTranslationFieldKeys (optional CSV), $aiTranslationFieldLimits (optional array) --}}
        ...
        @foreach ($contentLanguages as $lang)
            <li class="nav-item" role="presentation">
                <button
                    ...
                    id="tag-tab-trigger-{{ $lang->code }}"
                    data-bs-toggle="tab"
                    data-bs-target="#tag-tab-pane-{{ $lang->code }}"
                    role="tab"
                    aria-controls="tag-tab-pane-{{ $lang->code }}"
