...
@section('content')
    <div class="mb-auto container-fluid">
        ...
        @endforeach
        <form action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data" id="admin-item-create-form">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="admin-create-cover-drop-zone" class="upload-drop-zone rounded-3 border-2 border-dashed d-flex flex-column align-items-center justify-content-center p-3 text-center" style="min-height: 120px; border-color: #c8e6c9; background: #f1f8e9; cursor: pointer;">
                                    ...
                                    <div id="admin-create-cover-preview" class="d-none position-relative">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-secondary position-absolute bottom-0 end-0 m-1" id="admin-create-cover-replace-btn">{{ __('view.catalog.items.create.replace_image') }}</button>
                                    </div>
                                </div>
