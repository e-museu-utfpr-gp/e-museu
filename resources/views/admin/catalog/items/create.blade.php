            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="section_id" class="form-label">{{ __('view.admin.catalog.items.create.section') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="proprietary_id" class="form-label">{{ __('view.admin.catalog.items.create.collaborator') }}</label>
