            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row" data-section-item-selector 
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="section_id" class="form-label">{{ __('view.admin.catalog.extras.edit.section') }}</label>
                    ...
                    <div class="mb-3">
                        <label for="proprietary_id" class="form-label">{{ __('view.admin.catalog.extras.edit.collaborator') }}</label>
