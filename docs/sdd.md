...
- **2026-05-06:** GitHub Actions workflow uses repository **variables** `DEPLOY_HOOK_URL_PRODUCTION` / `DEPLOY_HOOK_URL_STAGING` for hook URLs; paste-friendly template `docs/deploy-coolify/github-actions-deploy.env.example`.
