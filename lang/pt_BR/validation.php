...
return [
    ...
    */
    ...
    'items' => [
        'translations' => [
            'incomplete_for_locale' => 'Em :locale, preencha nome e descrição se houver qualquer texto nesse idioma.',
            'at_least_one_locale' => 'Preencha nome e descrição em pelo menos um idioma.',
        ],
    ],

    'item_categories' => [
        'translations' => [
            'at_least_one_locale' => 'Preencha o nome em pelo menos um idioma.',
        ],
    ],
    ...
    'extras' => [
        'translations' => [
            'at_least_one_locale' => 'Preencha a informação extra em pelo menos um idioma.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'category_id' => 'categoria do item',
        'tag_category_id' => 'categoria da etiqueta',
