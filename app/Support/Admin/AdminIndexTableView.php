    ...
    public static function catalogItems(): array
    {
        return [
            'searchOptions' => [
                ...
                ['value' => 'location_id', 'label' => __('app.catalog.admin.items.index.search_option_location')],
                [
            ...
            'sortColumns' => [
                ...
                [
                    'sort' => 'identification_code',
                    'label' => __('app.catalog.admin.items.index.sort_code'),
                    'colClass' => 'admin-items-index-col admin-items-index-col--identification-code',
                ],
                ['sort' => 'validation', 'label' => __('app.catalog.admin.items.index.sort_validation')],
                [
                    'sort' => 'category_id',
                    'label' => __('app.catalog.admin.items.index.sort_item_category'),
                    'colClass' => 'admin-items-index-col admin-items-index-col--category',
                ],
                [
                    'sort' => 'location_id',
                    'label' => __('app.catalog.admin.items.index.sort_location'),
                    'colClass' => 'admin-items-index-col admin-items-index-col--location',
                ],
                [
                    'sort' => 'collaborator_id',
                    'label' => __('app.catalog.admin.items.index.sort_collaborator'),
                    'colClass' => 'admin-items-index-col admin-items-index-col--collaborator',
                ],
    ...
    public static function collaborators(): array
    {
        ...
        return [
            'searchOptions' => [
                ...
                ['value' => 'email', 'label' => __("$p.search_option_email")],
                ['value' => 'role', 'label' => __("$p.search_option_role")],
                ['value' => 'blocked', 'label' => __("$p.search_option_blocked")],
                ['value' => 'last_email_verification_at', 'label' => __("$p.search_option_last_email_verification_at")],
                ['value' => 'created_at', 'label' => __("$p.search_option_created_at")],
                ['value' => 'updated_at', 'label' => __("$p.search_option_updated_at")],
            ],
            'sortColumns' => [
                ...
                ['sort' => 'email', 'label' => __("$p.sort_email")],
                ['sort' => 'role', 'label' => __("$p.sort_role")],
                ['sort' => 'blocked', 'label' => __("$p.sort_blocked")],
                ['sort' => 'last_email_verification_at', 'label' => __("$p.sort_last_email_verification_at")],
                ['sort' => 'created_at', 'label' => __("$p.sort_created_at")],
                ['sort' => 'updated_at', 'label' => __("$p.sort_updated_at")],
                ['sort' => null, 'label' => ''],
            ],
