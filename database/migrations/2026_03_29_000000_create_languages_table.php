...
return new class extends Migration
{
     ...
     * Explicit ids: 1 = universal, 2 = pt_BR, 3 = en (display order in UI is still enforced in PHP, not by id).
     */
    public function up(): void
    {
        ...
        DB::table('languages')->insert([
            ['id' => 1, 'code' => 'universal', 'name' => 'Universal', 'created_at' => $now, 'updated_at' => $now],
